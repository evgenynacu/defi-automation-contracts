...
const func: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
	...
	await sendOrEstimate(hre, ex => depositToMorpho(ex, "0xb0a9ac81a8c6a5274aa1a8337aed35a2cb2cd4feb5c6d3b39d41f234fbf2955b", 49995000000n, 7.8))
}
...
//396354.215944328452892666 - 49995 * 6.8 * (1 + 0.08 * 50 / 365) - 49995